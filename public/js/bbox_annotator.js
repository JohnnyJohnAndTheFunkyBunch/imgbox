(function() {
  ...
  BBoxSelector = (function() {
    function BBoxSelector(image_frame, options) {
      ...
      this.selector.css({
        "border": this.border_width + "px dotted rgb(255,0,0)",
        "position": "absolute"
      });
  ...
  this.BBoxAnnotator = (function() {
    function BBoxAnnotator(options) {
      ...
      image_element.onload = function() {
        ...
        multiplier = options.width/maxwidth;
        annotator.annotator_element.css({
          "width": (options.width / multiplier + annotator.border_width * 2) + 'px',
          "height": (options.height / multiplier + annotator.border_width * 2) + 'px',
          "cursor": "crosshair"
        });
        annotator.image_frame.css({
          "background-image": "url('" + image_element.src + "')",
          "width": maxwidth + "px",
          "height": options.height/multiplier + "px",
          "position": "relative",
          "background-size": "100%"
        });
